...
3. **Progress directory**: Create the progress directory if it doesn't exist (`mkdir -p`).
...
Create the progress file using the template from `PROGRESS-FILE-TEMPLATE.md`.
