...
> Copy this to `{{PROGRESS_DIR}}/<feature-name>-progress.md` when starting a new feature. This file is the **crash-recovery artifact** — when a session terminates unexpectedly, the next session reads this to resume.
