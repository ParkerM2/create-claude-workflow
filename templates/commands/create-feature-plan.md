...
3. .claude/prompts/implementing-features/README.md                     — Playbook (for plan format)
4. .claude/prompts/implementing-features/CONTEXT-BUDGET-GUIDE.md       — Context estimation
5. .claude/prompts/implementing-features/QA-CHECKLIST-AUTO-FILL-RULES.md — Role-based QA
```
...
```
Base overhead (8,000) + files × 1,000 + margin (3,000) = estimated tokens

Task #1: 8,000 + 3 × 1,000 + 3,000 = ~14,000 tokens ✓
Task #2: 8,000 + 7 × 1,000 + 3,000 = ~18,000 tokens ⚠ (at threshold)
Task #3: 8,000 + 15 × 1,000 + 3,000 = ~26,000 tokens ✗ (must split)
```
...
Save to: `{{PROGRESS_DIR}}/<feature-name>-design.md`
...
═══════════════════════════════════════════════════════════
  ...
  Design Doc:   {{PROGRESS_DIR}}/<feature-name>-design.md
  Tasks:        <count>
  Waves:        <count>
...
═══════════════════════════════════════════════════════════
  ...
  The Team Leader will read the design document at:
    {{PROGRESS_DIR}}/<feature-name>-design.md

  The design document contains the full task breakdown,
  wave plan, file ownership, context budgets, and QA
  strategy — the Team Leader can execute it directly.
═══════════════════════════════════════════════════════════
```
...
- [ ] Design doc path follows the convention: `{{PROGRESS_DIR}}/<feature-name>-design.md`
